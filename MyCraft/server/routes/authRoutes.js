...
router.post('/login', async (req, res) => {
    try {
        ...
        // Cho phép đăng nhập ngay cả nếu email chưa xác thực
        // (cài sẵn tài khoản từ admin thì không cần xác thực)
        ...
        // Gửi cảnh báo nếu email chưa xác thực (user mới)
        const warning = !user.isVerified ? 'Email của bạn chưa được xác thực. Vui lòng kiểm tra email để xác nhận tài khoản.' : null;
